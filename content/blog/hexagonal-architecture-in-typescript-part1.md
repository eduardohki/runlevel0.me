...
It was after coming across this [this](https://alexis-lozano.com/hexagonal-architecture-in-rust-1/) excellent series of articles by *Alex Lozano* on Hexagonal Architecture, the final pieces fell into place.
...
```feature
Feature: As a Project Manager, I want to manage new and existing Project
